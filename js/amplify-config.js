...
const awsConfig = {
    Auth: {
        identityPoolId: 'us-west-1:5c4a1751-c014-438f-94b4-b3f6520bde62', // example: 'us-east-2:c85f3c18-05fd-4bb5-8fd1-e77e7627a99e'
        region: 'us-west-1', // example: 'us-east-2'
        userPoolId: 'us-west-1_gR6PkOivn', // example: 'us-east-2_teEUQbkUh'
        userPoolWebClientId: '6l1sjvrhlllj7f34bms2kolp7i' // example: '3k09ptd8kn8qk2hpk07qopr86'
    },
    API: {
        endpoints: [
            {
